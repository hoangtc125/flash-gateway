...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './pc.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PC_LIST actions', async () => {
    ...
    it('dispatches FETCH_PC actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PC actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PC actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PC actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PC actions', async () => {
      const expectedActions = [
        {
