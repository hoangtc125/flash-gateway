...
import com.flash.gateway.FlashGatewayApp;
import com.flash.gateway.config.AsyncSyncConfiguration;
import com.flash.gateway.config.EmbeddedMongo;
...
@SpringBootTest(classes = { FlashGatewayApp.class, AsyncSyncConfiguration.class })
@EmbeddedMongo
